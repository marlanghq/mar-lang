...
`
	...
	appViewModelSource := string(appViewModelBytes)
	if !strings.Contains(appViewModelSource, "// Generated by Mar ") {
		t.Fatalf("expected generated header in app view model, got:\n%s", appViewModelSource)
	}
	if !strings.Contains(appViewModelSource, "// This file may be overwritten by `mar ios generate`.") {
		t.Fatalf("expected overwrite warning in app view model header, got:\n%s", appViewModelSource)
	}
	if !strings.Contains(appViewModelSource, "// Do not edit this file manually.") {
		t.Fatalf("expected manual edit warning in app view model header, got:\n%s", appViewModelSource)
	}
	if !strings.Contains(appViewModelSource, `private let generatedServerURL = "https://school.example.com"`) {
