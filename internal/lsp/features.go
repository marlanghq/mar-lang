...
var (
	...
	keywordHoverDescriptions = map[string]string{
		...
		"frontend":                     "Declares an experimental App UI navigation model made of screens, sections, lists, links, fields, and actions.",
		"screen":                       "Declares a frontend screen. Use `screen PostDetail for Post { ... }` to render one entity row.",
		"section":                      "Declares a list-style frontend section. Sections may include an optional title and `when` condition.",
		"link":                         "Adds a navigation row to another frontend screen. Example: `link \"Public blogs\" to PublicBlogs`.",
		"to":                           "Used by frontend links to name the destination screen.",
		"list":                         "Displays rows for an entity in a frontend screen. Example: `list Blog { title name destination BlogDetail }`.",
		"children":                     "Displays rows that belong to the current entity row. Example: `children Comment by post { title body }`.",
		"by":                           "Used by frontend child lists to name the belongs_to field that points back to the current row.",
		"destination":                  "Sets the detail screen opened by frontend list rows.",
		"field":                        "Displays a field from the current row in a `screen ... for Entity` frontend screen.",
		"title":                        "Sets a frontend screen title or the title field for list rows.",
		"subtitle":                     "Sets the subtitle field for frontend list rows.",
