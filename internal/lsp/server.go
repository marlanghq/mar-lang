...
func keywordCompletionItems() []map[string]any {
	...
	types := []string{"string", "int", "decimal", "bool", "date", "datetime", "maybe", "list", "unit"}
	functions := []string{"if", "cond", "match", "let", "let*", "lambda", "begin", "get", "assoc", "just", "nothing", "unit", "cons", "first", "rest", "empty?", "map", "filter", "fold-left", "fold-right", "length", "contains", "starts-with", "ends-with", "matches"}
