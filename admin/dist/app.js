...
var $author$project$Belm$Api$Schema = F4(
	function (appName, portNumber, database, entities) {
		return {appName: appName, database: database, entities: entities, portNumber: portNumber};
	});
...
var $author$project$Belm$Api$decodeSchema = A5(
...
var $author$project$Main$loadSchema = function (apiBase) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotSchema, $author$project$Belm$Api$decodeSchema),
			url: apiBase + '/_belm/schema'
		});
};
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{apiBase: flags.apiBase, authToken: '', flash: $elm$core$Maybe$Nothing, formMode: $author$project$Main$FormHidden, formValues: $elm$core$Dict$empty, rows: $author$project$Main$NotAsked, schema: $author$project$Main$Loading, selectedEntity: $elm$core$Maybe$Nothing, selectedRow: $elm$core$Maybe$Nothing},
		...
		return $elm$http$Http$request(
			{
				...
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotCreate, $author$project$Belm$Api$rowDecoder),
		...
		return $elm$http$Http$request(
			{
				...
				expect: $elm$http$Http$expectWhatever($author$project$Main$GotDelete),
				headers: $author$project$Main$authHeaders(model),
				method: 'DELETE',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Main$loadRows = function (model) {
	...
	if (_v0.$ === 'Nothing') {
		...
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$emptyBody,
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotRows, $author$project$Belm$Api$decodeRows),
				headers: $author$project$Main$authHeaders(model),
				method: 'GET',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Main$updateRow = F4(
	function (model, entity, idValue, payload) {
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(payload),
				expect: A2($elm$http$Http$expectJson, $author$project$Main$GotUpdate, $author$project$Belm$Api$rowDecoder),
				headers: $author$project$Main$authHeaders(model),
				method: 'PATCH',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SelectEntity':
				...
				var nextModel = _Utils_update(
					model,
					{flash: $elm$core$Maybe$Nothing, formMode: $author$project$Main$FormHidden, formValues: $elm$core$Dict$empty, rows: $author$project$Main$Loading, selectedEntity: nextEntity, selectedRow: $elm$core$Maybe$Nothing});
				return _Utils_Tuple2(
					nextModel,
					$author$project$Main$loadRows(nextModel));
			case 'ReloadRows':
				...
				if (_v3.$ === 'Nothing') {
					...
					if (_v4.$ === 'Err') {
						...
						switch (_v5.$) {
							...
							case 'FormEdit':
								var rowValue = _v5.a;
								var _v6 = A2($author$project$Main$rowId, entity, rowValue);
								if (_v6.$ === 'Nothing') {
									return _Utils_Tuple2(
										_Utils_update(
											model,
			...
			case 'GotUpdate':
				...
				if (result.$ === 'Ok') {
					...
					var nextRows = function () {
						var _v11 = _Utils_Tuple2(model.selectedEntity, model.rows);
						if ((_v11.a.$ === 'Just') && (_v11.b.$ === 'Loaded')) {
							var entity = _v11.a.a;
							var items = _v11.b.a;
							return $author$project$Main$Loaded(
