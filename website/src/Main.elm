    ...
    column
        ...
        , panel
            ...
            , anchoredSection "compiler-and-runtime-commands"
                ...
                , commandRow model "8" "Completion" "Generates shell completion scripts for terminals such as zsh." "mar completion zsh"
                , commandRow model "9" "LSP" "Starts the language server used by the VSCode extension for diagnostics, hovers, and navigation. Usually started by the editor plugin." "mar lsp"
                , paragraphWithEmphasis
