        ...
        Just sectionId ->
            case sectionId of
                ...
                "system-configuration" ->
                    "System configuration. Use system when you need to tune runtime behavior. This is where request logging, body limits, and SQLite pragmas are configured."
...
docSearchEntries =
    ...
    , { title = "System config reference"
      ...
      , summary = "Reference for request logs, body limits, and SQLite tuning."
      , keywords = [ "system", "request_logs_buffer", "http_max_request_body_mb", "sqlite" ]
      }
    , { title = "Runtime"
    ...
    , { title = "System configuration"
      ...
      , summary = "Tune runtime behavior such as request logging, body limits, and SQLite settings."
      , keywords = [ "system", "runtime", "request logs", "body limits", "sqlite" ]
      }
        ...
        , panel
            ...
            , anchoredSection "system-configuration"
                ...
                , paragraphWithEmphasis
                    [ text "Use "
                    , emphasisText "system"
                    , text " when you need to tune runtime behavior. This is where request logging, body limits, and SQLite pragmas are configured."
                    ]
